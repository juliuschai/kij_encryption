...
def encrypt(data):
    ...
    # big endian
    chars = ''.join([
        chr((cl >> 24) & 0b11111111), chr((cl >> 16) & 0b11111111), chr((cl >> 8) & 0b11111111), chr(cl & 0b11111111),
        chr((cr >> 24) & 0b11111111), chr((cr >> 16) & 0b11111111), chr((cr >> 8) & 0b11111111), chr(cr & 0b11111111)
    ])
    return chars
